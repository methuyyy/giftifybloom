        ...
        <div class="w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-16">
            ...
            <div id="flower-grid"
                ...
                <?php $__currentLoopData = [
                    ['key' => 'Classic Dream',     'label' => 'Classic Dream',     'img' => 'card1.png'],
                    ['key' => 'Vintage',     'label' => 'Vintage',     'img' => 'card1.png'],
                    ['key' => 'Modern',    'label' => 'Modern',    'img' => 'card1.png'],
                    ['key' => 'Simple', 'label' => 'Simple', 'img' => 'card1.png'],
                    ['key' => 'Classic Dream',     'label' => 'Classic Dream',     'img' => 'card1.png'],
                    ['key' => 'Vintage',     'label' => 'Vintage',     'img' => 'card1.png'],
                    ['key' => 'Modern',    'label' => 'Modern',    'img' => 'card1.png'],
                    ['key' => 'Simple', 'label' => 'Simple', 'img' => 'card1.png'],
                    ...
                    >
                        ...
                        <div class="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 mb-3 sm:mb-4 flex items-center justify-center">
                            <img
                                src="<?php echo e(asset('images/customecard/' . $f['img'])); ?>"
...
<?php /**PATH C:\laragon\www\giftifybloom\resources\views\pick-card.blade.php ENDPATH**/ ?>