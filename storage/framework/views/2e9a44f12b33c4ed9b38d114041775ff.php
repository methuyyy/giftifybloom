    ...
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-16">
        <div class="relative w-full">
            ...
            <div class="absolute left-0 right-0 h-1.5 sm:h-[6px] lg:h-2 flex items-center
                ...
                <div class="h-full rounded-l-full <?php echo e($filledWidthClass); ?> bg-[#f5f0c0]"></div>
                <div class="h-full rounded-r-full <?php echo e($darkWidthClass); ?> bg-[#6d2857]"></div>
            </div>
            ...
            <div class="grid grid-cols-5 gap-1 sm:gap-2 lg:gap-4 relative z-10">
                <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="flex flex-col items-center justify-start">
                        <div
                            class="w-14 h-14 sm:w-16 sm:h-16 lg:w-[72px] lg:h-[72px] rounded-full flex items-center justify-center <?php echo e($circleClass); ?>"
                        >
                            <span
                                class="text-2xl sm:text-3xl lg:text-[34px] font-bold <?php echo e($numberClass); ?>"
                            >
...
<?php /**PATH C:\laragon\www\giftifybloom\resources\views\components\step-indicator.blade.php ENDPATH**/ ?>