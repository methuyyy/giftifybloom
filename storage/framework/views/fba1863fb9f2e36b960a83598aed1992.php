...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.step-indicator','data' => ['current' => 1]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
            ...
            <div id="flower-grid"
                ...
                <?php $__currentLoopData = [
                    ...
                    <div
                        ...
                        data-flower="<?php echo e($f['key']); ?>"
                        role="button"
                        tabindex="0"
                        aria-label="Pilih bunga <?php echo e($f['label']); ?>"
                    >
                        <div
                        ...
                        <div class="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 mb-3 sm:mb-4 flex items-center justify-center">
                            <img
                                src="<?php echo e(asset('images/pickflower/' . $f['img'])); ?>"
...
<?php endif; ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const nextUrl = "<?php echo e(route('pick.grocery')); ?>";
...
<?php /**PATH C:\laragon\www\giftifybloom\resources\views\pick-flowers.blade.php ENDPATH**/ ?>