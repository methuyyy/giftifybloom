    ...
    <div class="w-full max-w-7xl mx-auto">
        <div class="w-full bg-white rounded-full shadow-lg border border-gray-100 px-6 sm:px-10 lg:px-16 py-1 sm:py-1.5 flex items-center justify-between gap-6">
            ...
            <div class="hidden md:flex items-center gap-5 lg:gap-6">
                <a href="{{ route('shop') }}" class="text-base lg:text-lg font-medium text-gray-800 hover:text-[#8b5cf6] transition-colors duration-200">Shop all</a>
                <a href="{{ route('pick.flowers') }}" class="text-base lg:text-lg font-medium text-gray-800 hover:text-[#8b5cf6] transition-colors duration-200">Digital Bouquet</a>
                <a href="{{ route('about') }}" class="text-base lg:text-lg font-medium text-gray-800 hover:text-[#8b5cf6] transition-colors duration-200">About</a>
            </div>
            ...
            <div class="flex items-center justify-center flex-shrink-0">
                <a href="{{ url('/') }}" class="flex items-center">
                    <img src="{{ asset('images/logo.png') }}" alt="Giftify Bloom Logo"
            ...
            <div class="flex items-center gap-1">
                ...
                @auth
                    <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                        <button @click="open = !open" aria-label="Account menu"
                            ...
                            <span class="hidden sm:inline text-sm font-semibold text-gray-800 max-w-[80px] truncate">{{ auth()->user()->nama }}</span>
                        ...
                        <div x-show="open"
                             ...
                             style="display:none;">
                            <a href="{{ route('account') }}" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-[#f5f3ff] hover:text-[#6d2857] transition-colors">
                ...
                @else
                    <a href="{{ route('login') }}" aria-label="Login" class="p-1 sm:p-2 text-gray-700 hover:text-[#8b5cf6] transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 sm:h-8 sm:w-8" fill="none" stroke="currentColor" stroke-width="1.6" viewBox="0 0 24 24">
                            <circle cx="12" cy="8" r="4"/>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 20.25a7.5 7.5 0 0115 0"/>
                        </svg>
                ...
                <a href="{{ route('cart') }}" aria-label="Cart" class="relative p-1 sm:p-2 text-gray-700 hover:text-[#8b5cf6] transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 sm:h-8 sm:w-8" fill="none" stroke="currentColor" stroke-width="1.6" viewBox="0 0 24 24">
    ...
    <div x-show="mobileOpen"
        ...
        <div x-show="mobileOpen"
            ...
            <nav class="flex flex-col gap-1 px-4 py-4 flex-1">
                <a href="{{ url('/') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl text-gray-800 hover:bg-[#f5f3ff] hover:text-[#6d2857] font-medium transition-colors">
                ...
                <a href="{{ route('shop') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl text-gray-800 hover:bg-[#f5f3ff] hover:text-[#6d2857] font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#8b5cf6]" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                ...
                <a href="{{ route('pick.flowers') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl text-gray-800 hover:bg-[#f5f3ff] hover:text-[#6d2857] font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#8b5cf6]" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.395m3.42 3.42a15.995 15.995 0 004.764-4.648l3.876-5.814a1.151 1.151 0 00-1.597-1.597L14.146 6.32a15.996 15.996 0 00-4.649 4.763m3.42 3.42a6.776 6.776 0 00-3.42-3.42"/>
                    </svg>
                    Digital Bouquet
                </a>
                <a href="{{ route('about') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl text-gray-800 hover:bg-[#f5f3ff] hover:text-[#6d2857] font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#8b5cf6]" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z"/>
                    </svg>
                    About
                </a>
                <a href="{{ route('cart') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl text-gray-800 hover:bg-[#f5f3ff] hover:text-[#6d2857] font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#8b5cf6]" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z"/>
                    </svg>
                    Keranjang
                    @if ($cartCount > 0)
                        <span class="ml-auto inline-flex items-center justify-center min-w-[20px] h-5 px-1 rounded-full bg-[#8b5cf6] text-white text-xs font-bold">{{ $cartCount }}</span>
                    @endif
                </a>

                <div class="border-t border-gray-100 mt-2 pt-2">
                    @auth
                        <a href="{{ route('account') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl text-gray-800 hover:bg-[#f5f3ff] hover:text-[#6d2857] font-medium transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#8b5cf6]" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                                <circle cx="12" cy="8" r="4"/><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 20.25a7.5 7.5 0 0115 0"/>
                            </svg>
                            My Account
                    ...
                    @else
                        <a href="{{ route('login') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl text-gray-800 hover:bg-[#f5f3ff] hover:text-[#6d2857] font-medium transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#8b5cf6]" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                                <circle cx="12" cy="8" r="4"/><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 20.25a7.5 7.5 0 0115 0"/>
                            </svg>
                            Login / Register
