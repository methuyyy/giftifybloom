                        ...
                        @foreach ($mobileTabs as $mt)
                            <button type="button"
                                    ...
                                    class="mobile-tab-btn px-4 py-2 rounded-full text-sm font-bold border-2 transition-all whitespace-nowrap
                                           {{ $loop->first ? 'bg-[#6d2857] text-white border-[#6d2857]' : 'bg-white text-[#504068] border-[#d9c7ee] hover:border-[#8b5cf6] hover:text-[#6d2857]' }}">
                                {{ $mt['label'] }}
                            </button>
                        @endforeach
                    ...
                    <div id="tab-pesanan" class="account-tab-panel hidden">
                        <div class="w-full bg-white/90 backdrop-blur-sm rounded-[24px] border border-[#ecdfff] shadow-[0_8px_24px_rgba(109,40,87,0.07)] p-6 sm:p-7">
                            ...
                            <div class="flex flex-col items-center justify-center py-12 text-center">
                                ...
                                <a href="{{ route('shop') }}" class="mt-5 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#9f7aea] via-[#8b5cf6] to-[#6d2857] text-white font-bold text-sm py-3 px-8 shadow-[0_10px_24px_rgba(109,40,87,0.25)] hover:-translate-y-0.5 transition-all duration-200">
                                    Mulai Belanja
                                </a>
                            </div>
                        </div>
